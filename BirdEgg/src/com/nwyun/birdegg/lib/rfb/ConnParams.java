...
import com.nwyun.birdegg.lib.rdr.InStream;
import com.nwyun.birdegg.lib.rdr.OutStream;
...
public class ConnParams {
	...
	public boolean readVersion(InStream is) {
		...
		try {
			...
			// On IE 5.0, the above test causes an exception if executed
			// unmodified.
			// Wrapping it inside a try/catch block is the cleanest way of
			// fixing it.
			return false;
		}
